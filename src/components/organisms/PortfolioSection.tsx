  ...
  const projects = [
    {
      ...
      descriptionHook: 'Crafted for cafés, this collaborative C# WPF Point of Sale system efficiently manages customer orders, sales, and product inventory.',
      descriptionLong: [
        '"Overkill P.O.S." was a collaborative software development project I undertook with my team at NTIG Uppsala. We designed it as a robust desktop Point of Sale (POS) system tailored specifically for café environments. Our primary goal was to streamline daily operations by efficiently managing customer orders, processing sales, and organizing product inventory, thereby addressing the typical challenges of manual tracking and potential inefficiencies in a fast-paced café setting.',
        'The application evolved significantly from its initial version (v1.0.0) through to v1.5.3 and beyond, as we incorporated a suite of features essential for café management. Core functionalities include comprehensive sales processing, detailed order management, and product cataloging. User experience was a key focus for us, leading to our implementation of an intuitive undo/redo capability for sales entries, which required diligent bug-fixing on our part to perfect.',
        'To further enhance usability, the system features dynamic button generation that adapts to available products and categories, and an auto-scrolling transaction log to maintain visibility of current order items. We also developed a dedicated "TestSystem" project in parallel to ensure quality and reliability through consistent testing. For deployment, our team utilized Advanced Installer to create user-friendly .msi installers, simplifying the setup process for end-users.',
        'The technological backbone of "Overkill P.O.S." is C# utilizing the .NET Framework, with Windows Presentation Foundation (WPF) which we chose for crafting the graphical user interface. We carried out development within Visual Studio, while version control and collaborative code management were handled using Git and GitHub, under our NTIG-Uppsala organization. Notably, as per our teacher\'s instruction, I explored with a colleague a conceptual redesign phase using Adobe XD to investigate alternative UI/UX paradigms. These conceptual designs were part of an internal exploration and were not published in the project\'s GitHub repository.',
        'This project was a true team effort, involving contributions from all team members. Our collaborative process was structured through the use of an `.editorConfig` file to maintain code consistency, and adherence to internal documentation such as a "Project Standard" and a "Definition of Done." We progressed development through versioned releases available on GitHub, with each new feature or bug fix accompanied by corresponding updates to our test system, reflecting our iterative and quality-focused approach.',
        'The "Overkill P.O.S." project provided extensive learning opportunities for me and all my teammates, covering the full lifecycle of desktop application development – from initial design and development through to rigorous testing and packaging for installation. We all honed our skills in C#, WPF, the .NET Framework, Visual Studio, and Git. I personally gained significant experience in practical problem-solving, such as tackling the complexities of the undo/redo functionality. The project also offered me profound insights into the software development life cycle (SDLC), effective team collaboration, and the utility of conceptual design exploration with tools like Adobe XD.',
        'In conclusion, "Overkill P.O.S." stands as a well-documented and functional desktop application, which we successfully developed as a student team to address a real-world scenario. It not only demonstrates our proficient technical implementation of a POS system but also highlights our maturing development process, a strong emphasis on usability, and our proactive planning for future enhancements. This project effectively showcases our team\'s capability to deliver a complete software solution from concept to deployment.'
      ],
